import svgPaths from "./svg-lx4w2ioy3x";
...
export default function PanelBaseComponentsLinkListItem() {
  return (
    <div className="content-stretch flex gap-[16px] items-start px-[16px] py-[14px] relative size-full" data-name="Panel Base Components / Link List Item">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <LeftIconWrapper />
      <Content />
      <RightIconWrapper />

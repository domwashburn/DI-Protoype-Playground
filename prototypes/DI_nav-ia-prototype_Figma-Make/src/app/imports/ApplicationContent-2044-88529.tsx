import svgPaths from "./svg-a4ahh9tgsi";
  ...
  return (
    <div className="basis-0 grow h-[48px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[48px] items-center pl-0 pr-[16px] py-0 relative w-full">
          <p className="font-['IBM_Plex_Sans:SemiBold',_sans-serif] leading-[22px] not-italic relative shrink-0 text-[#161616] text-[16px] text-nowrap whitespace-pre">Master data</p>
        </div>
      </div>
    </div>
  );
...
function NavHeader() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-start mix-blend-multiply overflow-clip relative shrink-0 w-[256px]" data-name="Nav header">
      <Frame630776 />
      <Text />
    </div>
  );
...
function Text1() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Master data overview</p>
    </div>
  );
}
...
function NavItemContent() {
  return (
    <div className="bg-white box-border content-stretch flex h-full items-center mix-blend-multiply px-0 py-[7px] relative shrink-0 w-[256px]" data-name="Nav item content">
      <Icon1 />
      <Text1 />
...
function MasterDataOverview() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center mix-blend-multiply overflow-clip relative shrink-0" data-name="Master data overview">
...
function Text2() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Search master data</p>
    </div>
  );
}
...
function SearchMasterData() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center mix-blend-multiply overflow-clip relative shrink-0" data-name="Search master data">
      <div className="flex flex-row items-center self-stretch">
        <NavItemContent1 />
      </div>
    </div>
...
function Text3() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Master data workspace</p>
    </div>
  );
}
...
function MasterDataWorkspace() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center mix-blend-multiply overflow-clip relative shrink-0" data-name="Master data workspace">
      <div className="flex flex-row items-center self-stretch">
        <NavItemContent2 />
      </div>
    </div>
...
function NavItemContent3() {
  return (
    <div className="bg-white box-border content-stretch flex h-full items-center mix-blend-multiply px-[16px] py-[8px] relative shrink-0 w-[256px]" data-name="Nav item content">
      <ZeroHeightContainer />
      <div className="absolute inset-0 pointer-events-none shadow-[0px_0px_0px_0px_inset_#0f62fe]" />
    </div>
  );
...
function Text4() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Assets</p>
    </div>
  );
}
...
function Assets() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center mix-blend-multiply overflow-clip relative shrink-0" data-name="Assets">
      <div className="flex flex-row items-center self-stretch">
        <NavItemContent4 />
      </div>
    </div>
...
function Text5() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Data types</p>
    </div>
  );
}
...
function NavItemContent5() {
  return (
    <div className="bg-[rgba(141,141,141,0.2)] box-border content-stretch flex items-center px-0 py-[7px] relative shrink-0 w-[256px]" data-name="Nav item content">
...
function DataTypes() {
  return (
    <div className="content-stretch flex items-center overflow-clip relative shrink-0" data-name="Data types">
      <NavItemContent5 />
    </div>
  );
}
...
function Text6() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Task types</p>
    </div>
  );
}
...
function TaskTypes() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center mix-blend-multiply overflow-clip relative shrink-0" data-name="Task types">
      <div className="flex flex-row items-center self-stretch">
        <NavItemContent6 />
      </div>
    </div>
...
function Text7() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Pair review</p>
    </div>
  );
}
...
function PairReview() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center mix-blend-multiply overflow-clip relative shrink-0" data-name="Pair review">
      <div className="flex flex-row items-center self-stretch">
        <NavItemContent8 />
      </div>
    </div>
...
function Text8() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Jobs</p>
    </div>
  );
}
...
function Jobs() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center mix-blend-multiply overflow-clip relative shrink-0" data-name="Jobs">
      <div className="flex flex-row items-center self-stretch">
        <NavItemContent9 />
      </div>
    </div>
...
function Text9() {
  return (
    <div className="box-border content-stretch flex h-full items-center pl-0 pr-[16px] py-0 relative shrink-0 w-[181px]" data-name="Text">
      <p className="basis-0 font-['IBM_Plex_Sans:Regular',_sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px]">Instance settings</p>
    </div>
  );
}
...
function InstanceSettings() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center mix-blend-multiply overflow-clip relative shrink-0" data-name="Instance settings">
      <div className="flex flex-row items-center self-stretch">
        <NavItemContent11 />
      </div>
    </div>
...
function Match360L1Nav() {
  return (
    <div className="absolute bg-white bottom-0 left-0 top-0 z-[3]" data-name="Match 360 L1 nav">
      <div className="content-stretch flex flex-col h-full items-start overflow-clip relative">
        <NavHeader />
        <NavItems />
      </div>
...
function PageContent1() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0 z-[1]" data-name="page content">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] items-start pb-0 pl-[16px] pr-[32px] pt-[16px] relative size-full">
          <Notification />
          <PageContent />
        </div>
      </div>
...
function RightHandPanel() {
  return (
    <div className="bg-white h-[827px] max-w-[320px] min-w-[320px] relative shrink-0 w-[320px] z-[1]" data-name="right hand panel">
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[0px_0px_0px_1px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}

import svgPaths from "./svg-6o4id2zhn8";
...
function Paragraph() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[287px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
    ...
    <div className="relative shrink-0 w-full z-[1]">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] relative size-full">
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-px items-start min-h-px min-w-px relative" data-name="Panel Base Components / Link List">
...
function Frame3() {
  return (
    <div className="relative shrink-0 w-full z-[1]">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] relative size-full">
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-px isolate items-start min-h-px min-w-px relative" data-name="Panel Base Components / Link List">
...
function Paragraph1() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] min-h-px min-w-px not-italic relative text-[#c6c6c6] text-[12px] text-center tracking-[0.32px]">IBM Decision Intelligence v0.0.0</p>
    </div>
  );
}

import svgPaths from "./svg-43868jhc85";
...
function ButtonContent1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Button content">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] isolate items-center px-[16px] py-[7px] relative w-full">
          <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#0f62fe] text-[14px] tracking-[0.16px] whitespace-nowrap z-[3]">New decision automation</p>
...
function Resizer() {
  return (
    <div className="content-stretch flex flex-col gap-[715px] h-[532px] items-start relative shrink-0" data-name="Resizer">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <Start />
      <End />
    </div>
...
function DecisionProjectsList() {
  return (
    <div className="flex-[1_0_0] gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[___168px_168px_168px] min-h-px min-w-px overflow-clip relative self-stretch" data-name="decision projects list">
      <div className="bg-[#f4f4f4] col-[1/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-1 shrink-0" data-name="Home page components / asset tile">
      ...
      <div className="bg-[#f4f4f4] col-[1/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-2 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent1 />
            <SecondaryContent1 />
      ...
      <div className="bg-[#f4f4f4] col-[9/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-1 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent2 />
            <SecondaryContent2 />
      ...
      <div className="bg-[#f4f4f4] col-[9/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-2 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent3 />
            <SecondaryContent3 />
      ...
      <div className="bg-[#f4f4f4] col-[5/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-1 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent4 />
            <SecondaryContent4 />
      ...
      <div className="bg-[#f4f4f4] col-[5/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-2 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent5 />
            <SecondaryContent5 />
      ...
      <div className="bg-[#f4f4f4] col-[1/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-3 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent6 />
            <SecondaryContent6 />
      ...
      <div className="bg-[#f4f4f4] col-[5/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-3 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent7 />
            <SecondaryContent7 />
...
function HomePageRecentProjectsProjectGrid() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="Home page • Recent Projects -> Project grid">
      <SectionActions />
...
export default function DecisionAutomationProjectsRow() {
  return (
    <div className="bg-[#e8e8e8] content-stretch flex gap-[16px] items-start px-[32px] py-[64px] relative size-full" data-name="Decision automation projects row">
      <div className="content-stretch flex flex-col items-start max-w-[304px] min-w-[224px] overflow-clip relative shrink-0 w-[224px]" data-name="components / Section title group">
        <Frame />
      </div>

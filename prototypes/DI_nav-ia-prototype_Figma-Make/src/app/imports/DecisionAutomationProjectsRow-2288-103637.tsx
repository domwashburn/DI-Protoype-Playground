import svgPaths from "./svg-ucfaofxdh2";
...
function Frame630846() {
  return (
    <div className="content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',_sans-serif] gap-[8px] items-start not-italic relative shrink-0 w-full">
      ...
      <p className="-webkit-box css-idt30j leading-[18px] overflow-ellipsis overflow-hidden relative shrink-0 text-[14px] text-neutral-600 tracking-[0.16px] w-full">Open decision projects that you created, modified, or viewed</p>
    </div>
  );
}
...
function ArrowRight() {
  return (
    <div className="absolute right-0 size-[16px] top-[calc(50%+0.498px)] translate-y-[-50%]" data-name="Arrow--right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Arrow--right">
          <rect fill="white" fillOpacity="0.01" height="16" style={{ mixBlendMode: "multiply" }} width="16" />

import svgPaths from "./svg-wtan44fh3t";
...
function Resizer() {
  return (
    <div className="content-stretch flex flex-col gap-[720px] items-start relative shrink-0" data-name="Resizer">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
      <Start />
      <End />
    </div>
...
function DecisionProjectsList() {
  return (
    <div className="flex-[1_0_0] gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(8,minmax(0,1fr))] grid-rows-[____168px_168px_168px_168px] min-h-px min-w-px overflow-clip relative self-stretch" data-name="decision projects list">
      ...
      <div className="bg-[#f4f4f4] col-[1/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-4 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent3 />
            <SecondaryContent3 />
      ...
      <div className="bg-[#f4f4f4] col-[5/span_4] h-[168.001px] justify-self-stretch max-h-[168.00100708007812px] min-h-[168.00100708007812px] relative row-4 shrink-0" data-name="Home page components / asset tile">
        <div className="max-h-[inherit] min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col gap-[16px] isolate items-start max-h-[inherit] min-h-[inherit] p-[16px] relative size-full">
            <PrimaryContent7 />
            <SecondaryContent7 />
...
function HomePageRecentProjectsProjectGrid() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0 w-full" data-name="Home page • Recent Projects -> Project grid">
      <SectionActions />
...
export default function DecisionAutomationProjectsRow() {
  return (
    <div className="bg-[#e8e8e8] content-stretch flex flex-col gap-[16px] items-start pb-[64px] pl-[16px] pr-[32px] relative size-full" data-name="Decision automation projects row">

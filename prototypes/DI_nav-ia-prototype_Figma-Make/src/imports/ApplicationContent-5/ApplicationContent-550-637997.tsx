import svgPaths from "./svg-tpfd9k19rr";
import { imgChatContentScrollArea, imgGradientWrapper, imgGradientStop1, imgGradientFeather, imgGradientStop2 } from "./svg-71w0l";
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[2px] pr-[8px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['IBM_Plex_Sans:SemiBold',sans-serif] h-full justify-center leading-[0] min-w-px not-italic overflow-hidden relative text-[#161616] text-[14px] text-ellipsis tracking-[0.16px] whitespace-nowrap">
            <p className="leading-[18px] overflow-hidden text-ellipsis">Chats</p>
          </div>
        </div>
      </div>
    </div>
...
function Icon3() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 z-[1]" data-name="Icon">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Side-panel--close">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <div className="absolute inset-[12.5%_6.25%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 12">
            <path d={svgPaths.p467f480} fill="var(--fill-0, #161616)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function RightActions() {
  return (
    <div className="content-stretch flex items-start relative shrink-0" data-name="Right actions">
...
function Filter() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Filter">
      <div className="flex h-[16px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-0 relative w-[16px]" data-name="Border">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 1">
                <line id="Border" stroke="var(--stroke-0, #C6C6C6)" x2="16" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
...
function ChatShellCustomSlotsCarbonForAi() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px overflow-clip relative shadow-[0px_23px_40px_-24px_rgba(15,98,254,0.1)] w-full z-[1]" data-name="Chat shell [custom slots] | Carbon for AI">
      <div aria-hidden="true" className="absolute bg-white inset-0 mix-blend-multiply pointer-events-none" />
...
function PageContent() {
  return (
    <div className="bg-[#f4f4f4] content-stretch flex flex-[1_0_0] flex-col h-[827px] isolate items-start min-w-px overflow-x-clip overflow-y-auto relative z-[1]" data-name="Page Content">
...
function SectionWrapper() {
  return (
    <div className="content-stretch flex flex-[1_0_0] isolate items-center min-w-px relative" data-name="Section Wrapper">
      <div className="content-stretch flex flex-col h-[827px] items-start max-w-[48px] relative shrink-0 w-[48px] z-[3]" data-name="DI Side Rails">
        <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative" data-name="Side Rail">
      ...
      <div className="flex flex-row items-center self-stretch">
        <div className="bg-white h-full relative shrink-0 w-[320px] z-[2]" data-name="Chat History">
          ...
          <div aria-hidden="true" className="absolute border-[#c6c6c6] border-r border-solid inset-[0_-1px_0_0] pointer-events-none" />
        </div>
      </div>
      <PageContent />
    </div>
...
export default function ApplicationContent() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="Application Content">
      <SectionWrapper />
    </div>
  );
}
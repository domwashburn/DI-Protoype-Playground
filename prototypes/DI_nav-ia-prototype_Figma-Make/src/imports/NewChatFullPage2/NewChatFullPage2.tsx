import svgPaths from "./svg-lhtigzd5o7";
import { imgChatContentScrollArea, imgGradientWrapper, imgGradientStop1, imgGradientFeather, imgGradientStop2 } from "./svg-1jmqx";
...
function SourceTimestamp() {
  return (
    <div className="relative shrink-0 w-full" data-name="Source + Timestamp">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="[word-break:break-word] content-stretch flex font-['IBM_Plex_Sans:Regular',sans-serif] gap-[4px] items-center justify-end leading-[0] not-italic pb-[2px] px-[16px] relative size-full text-[#525252] text-[12px] text-right tracking-[0.32px] whitespace-nowrap">
          <div className="flex flex-col justify-center relative shrink-0">
            <p className="leading-[16px]">You</p>
          </div>
          <div className="flex flex-col justify-center relative shrink-0">
            <p className="leading-[16px]">12:46</p>
          </div>
        </div>
      </div>
    </div>
...
function Bubble() {
  return (
    <div className="bg-[#e0e0e0] content-stretch flex flex-col gap-[4px] items-end mb-[-32px] px-[16px] py-[6px] relative rounded-[8px] shrink-0" data-name="Bubble">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] whitespace-nowrap">Create a decision service</p>
      <div className="absolute bg-[#e0e0e0] right-0 size-[8px] top-0" data-name="Bubble corner">
        <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0)] border-l border-solid border-t inset-0 pointer-events-none" />
      </div>
    </div>
  );
}
...
function Bubble1() {
  return (
    <div className="bg-[#e0e0e0] content-stretch flex flex-col gap-[4px] items-end px-[16px] py-[6px] relative rounded-[8px] shrink-0" data-name="Bubble">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] whitespace-nowrap">Create a decision service</p>
      <div className="absolute bg-[#e0e0e0] right-0 size-[8px] top-0" data-name="Bubble corner">
        <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0)] border-l border-solid border-t inset-0 pointer-events-none" />
      </div>
    </div>
...
function Bubbles() {
  return (
    <div className="content-stretch flex flex-col items-end overflow-clip relative rounded-bl-[8px] rounded-tl-[8px] shrink-0 w-full" data-name="Bubbles">
      <Bubble />
      <Bubble1 />
    </div>
  );
...
function BubbleSlot() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-end min-w-px relative" data-name="Bubble + Slot">
      <Bubbles />
    </div>
  );
}
...
function AvatarBubble() {
  return (
    <div className="relative shrink-0 w-full" data-name="Avatar + Bubble">
      <div className="content-stretch flex gap-[8px] items-start pl-[56px] pr-[16px] relative size-full">
        <BubbleSlot />
      </div>
    </div>
  );
...
function SourceTimestamp1() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['IBM_Plex_Sans:Regular',sans-serif] gap-[4px] items-center leading-[0] not-italic py-[8px] relative shrink-0 text-[#525252] text-[12px] text-right tracking-[0.32px] whitespace-nowrap" data-name="Source + Timestamp">
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <div className="[word-break:break-word] flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#525252] text-[12px] tracking-[0.32px] whitespace-nowrap">
        <p className="leading-[16px]">View reasoning</p>
      </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Message">
      <div className="content-stretch flex flex-col items-start pr-[16px] relative size-full">
        <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] w-full">Done! I have created a decision service</p>
      </div>
    </div>
  );
}
...
function IconContainer() {
  return (
    <div className="h-[40px] overflow-clip relative shrink-0 w-[16px]" data-name="Icon container">
      <div className="absolute bg-[rgba(255,255,255,0)] left-0 overflow-clip size-[16px] top-[2px]" data-name="Task">
        <div className="absolute inset-[6.25%_15.63%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 14">
            <g id="Vector">
              <path d={svgPaths.p7452400} fill="#161616" />
              <path d={svgPaths.p28731300} fill="#161616" />
            </g>
          </svg>
        </div>
      </div>
...
function TitleSubtitle() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col font-['IBM_Plex_Sans:Regular',sans-serif] gap-[2px] items-start justify-center min-w-px not-italic relative whitespace-nowrap" data-name="title + subtitle">
      <p className="leading-[22px] overflow-hidden relative shrink-0 text-[#161616] text-[16px] text-ellipsis w-full">Loan approval service</p>
      <p className="leading-[16px] overflow-hidden relative shrink-0 text-[#525252] text-[12px] text-ellipsis tracking-[0.32px] w-full">{`<Automation name>`}</p>
    </div>
  );
}
...
function SlugMargin() {
  return (
    <div className="content-stretch flex flex-col items-start pt-px relative shrink-0" data-name="Slug margin">
      <div className="bg-[#161616] relative shrink-0 size-[4px]" data-name="Slug" />
    </div>
  );
}
...
function AiWrapper() {
  return (
    <div className="relative self-stretch shrink-0" data-name="ai wrapper">
      <div className="content-stretch flex items-start py-[2px] relative size-full">
        <div className="content-stretch flex gap-[3px] items-center relative shrink-0" data-name="AI label - Inline">
          <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
          <SlugMargin />
          <p className="[word-break:break-word] font-['IBM_Plex_Sans:SemiBold',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#161616] text-[12px] text-center whitespace-nowrap">AI</p>
        </div>
      </div>
    </div>
  );
...
function TitleSubtitleAiLabel() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-[216px]" data-name="title + subtitle + ai label">
      <IconContainer />
      <TitleSubtitle />
      <AiWrapper />
    </div>
...
function ArtifactTitleDate() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="artifact title + date">
      <TitleSubtitleAiLabel />
    </div>
  );
}
...
function TopSection() {
  return (
    <div className="relative shrink-0 w-full" data-name="top section">
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-b border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[8px] items-start pb-[12px] pt-[14px] px-[16px] relative size-full">
        <ArtifactTitleDate />
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Button content">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] isolate items-center px-[16px] py-[11px] relative size-full">
          <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#0f62fe] text-[14px] tracking-[0.16px] whitespace-nowrap z-[3]">Go to service</p>
        </div>
      </div>
    </div>
  );
...
function ActionableArea() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[40px] items-center min-w-px py-[16px] relative rounded-bl-[8px] rounded-br-[8px]" data-name="actionable area">
      <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <ButtonContent3 />
      </div>
    </div>
...
function ContentTileContainer() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="content tile container">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <TopSection />
        <div className="bg-white content-stretch flex h-[40px] items-start relative rounded-bl-[8px] rounded-br-[8px] shrink-0 w-full" data-name="_Workspace preview footer item">
          <div aria-hidden="true" className="absolute border-[#e0e0e0] border-b border-l border-r border-solid inset-0 pointer-events-none rounded-bl-[8px] rounded-br-[8px]" />
          <ActionableArea />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-l border-r border-solid border-t inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function MainContent() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Main content">
      <div className="content-stretch flex h-[24px] items-center relative rounded-[8px] shrink-0" data-name="Reasoning trace">
        <div aria-hidden="true" className="absolute bg-white inset-0 mix-blend-multiply pointer-events-none rounded-[8px]" />
        <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Source + Timestamp + Accordion">
          <div className="content-stretch flex items-center relative shrink-0" data-name="Source + Timestamp + History">
            <SourceTimestamp1 />
          </div>
          <div className="content-stretch flex gap-[8px] items-center pl-[8px] relative shrink-0" data-name="Accordion">
            <div className="[word-break:break-word] flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#6f6f6f] text-[12px] text-ellipsis text-right tracking-[0.32px] whitespace-nowrap">
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start py-[4px] relative shrink-0 w-full" data-name="Content">
      <div className="h-[16px] opacity-0 relative shrink-0 w-full" data-name="Spacer" />
      <Message />
    </div>
  );
...
function ChatSectionCarbonForAi() {
  return (
...
function ChatContentMask() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Chat content mask">
...
function ChatShellCustomSlotsCarbonForAi() {
  return (
    <div className="absolute content-stretch flex flex-col h-[852px] items-center overflow-clip right-0 shadow-[0px_23px_40px_-24px_rgba(15,98,254,0.1)] top-[48px] w-[1265px]" data-name="Chat shell [custom slots] | Carbon for AI">
...
function Frame1() {
  return (
    <div className="bg-white content-stretch flex items-center px-[8px] py-[4px] relative shrink-0">
      <div className="bg-[rgba(141,141,141,0.12)] content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[32px]" data-name="Button">
        <ButtonContent7 />
      </div>
    </div>
  );
...
function Group() {
  return (
    <div className="absolute contents left-[24px] top-[71px]">
      <div className="absolute left-[24px] size-[24px] top-[71px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
          <circle cx="12" cy="12" fill="var(--fill-0, #F7FF00)" id="Ellipse 1" r="12" />
        </svg>
      </div>
      <div className="absolute left-[24px] size-[24px] top-[71px]" data-name="Cursor">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
...
function TooltipContent1() {
  return (
    <div className="relative shrink-0 w-full z-[2]" data-name="Tooltip content">
      <div className="content-stretch flex flex-col isolate items-start px-[16px] py-[2px] relative size-full">
        <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] max-w-[176px] not-italic relative shrink-0 text-[14px] text-white tracking-[0.16px] whitespace-nowrap z-[2]">New chat</p>
        <div className="absolute bg-[#393939] inset-0 rounded-[2px] z-[1]" data-name="Background" />
      </div>
    </div>
  );
...
export default function NewChatFullPage() {
  return (
    <div className="bg-white relative size-full" data-name="New chat: Full page 2">
      ...
      <Group1 />
      <div className="absolute content-stretch flex isolate items-center left-[52px] top-[57px]" data-name="Tooltip body item">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <div className="flex h-[16px] items-center justify-center relative shrink-0 w-[4px] z-[2]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
          <div className="-rotate-90 -scale-y-100 flex-none">
            <div className="content-stretch flex flex-col items-center px-[4px] relative" data-name="_Tooltip caret item">
              <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
              <div className="h-[4px] relative shrink-0 w-[8px]" data-name="Vector">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 4">
                  <path d="M0 0L4 4L8 0H0Z" fill="var(--fill-0, #393939)" id="Vector" />

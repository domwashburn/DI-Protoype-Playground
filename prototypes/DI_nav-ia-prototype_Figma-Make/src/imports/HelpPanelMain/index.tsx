import svgPaths from "./svg-t2riy11scf";

function Heading() {
  return (
    <div className="h-[28px] relative shrink-0 w-[161.844px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[28px] left-0 not-italic text-[#f4f4f4] text-[20px] top-0 whitespace-nowrap">Get help</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[287px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#c6c6c6] text-[14px] top-[-0.5px] tracking-[0.16px] w-[260px]">Get help and learn more about Decision Intelligence</p>
      </div>
    </div>
  );
}
...
function SectionTitleWrapper() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[5px] items-start min-w-px relative" data-name="Section title wrapper">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] not-italic overflow-hidden relative shrink-0 text-[#c6c6c6] text-[12px] text-ellipsis tracking-[0.32px] whitespace-nowrap">Tours and demos</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip pl-[8px] pr-[16px] relative shrink-0 z-[1]" data-name="Right content wrapper">
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Link">
        ...
        <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#78a9ff] text-[12px] tracking-[0.32px] whitespace-nowrap">View all</p>
      </div>
    </div>
  );
}
...
function PanelModulesList() {
  return (
    <div className="content-stretch flex flex-col gap-px isolate items-start min-w-[320px] pb-[16px] relative shrink-0 w-[320px]" data-name="Panel Modules / List">
      <div className="bg-[#161616] content-stretch flex h-[32px] isolate items-center shrink-0 sticky top-0 w-full z-[6]" data-name="Panel Base Components / Section title">
        <LeftContentWrapper />
        <RightContentWrapper />
      </div>
      <Frame6 />
...
function SectionTitleWrapper1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[5px] items-start min-w-px relative" data-name="Section title wrapper">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] not-italic overflow-hidden relative shrink-0 text-[#c6c6c6] text-[12px] text-ellipsis tracking-[0.32px] whitespace-nowrap">Relevant articles</p>
    </div>
  );
}
...
function Content5() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col font-['IBM_Plex_Sans:Regular',sans-serif] items-start min-w-px not-italic overflow-clip relative whitespace-nowrap" data-name="Content">
...
function SectionTitleWrapper2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[5px] items-start min-w-px relative" data-name="Section title wrapper">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[16px] not-italic overflow-hidden relative shrink-0 text-[#c6c6c6] text-[12px] text-ellipsis tracking-[0.32px] whitespace-nowrap">More resources</p>
    </div>
  );
}
...
function RightContentWrapper2() {
  return <div className="content-stretch flex flex-col h-[16px] items-start overflow-clip pl-[8px] pr-[16px] relative shrink-0 w-[69px] z-[1]" data-name="Right content wrapper" />;
}
...
function Content10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">Quick start guide</p>
    </div>
  );
}
...
function Content11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">Video tutorials</p>
    </div>
  );
}
...
function Content12() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">Contact support</p>
    </div>
  );
}
...
function Content13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">Community forum</p>
    </div>
  );
}
...
function Content14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">Release notes</p>
    </div>
  );
}
...
function Content15() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">API documentation</p>
    </div>
  );
}
...
function Content16() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">MCP documentation</p>
    </div>
  );
}
...
function Content17() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">What’s new</p>
    </div>
  );
}
...
function Content18() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative" data-name="Content">
      <p className="[word-break:break-word] font-['IBM_Plex_Sans:Regular',sans-serif] leading-[20px] not-italic overflow-hidden relative shrink-0 text-[#f4f4f4] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-nowrap">Product documentation</p>
    </div>
  );
}
...
export default function HelpPanelMain() {
  return (
    <div className="bg-[#161616] content-stretch flex flex-col items-start justify-center relative size-full" data-name="Help Panel -> Main">
      <Container />
      <Frame />
      <Container2 />
    </div>

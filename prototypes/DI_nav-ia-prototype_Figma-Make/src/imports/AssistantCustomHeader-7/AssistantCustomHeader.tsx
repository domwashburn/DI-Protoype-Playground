import svgPaths from "./svg-9vghoj7p7e";
...
function PanelTitle() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Panel Title">
      <div className="content-stretch flex gap-[4px] items-center max-w-[312px] min-w-[40px] relative shrink-0" data-name="Custom chat header">

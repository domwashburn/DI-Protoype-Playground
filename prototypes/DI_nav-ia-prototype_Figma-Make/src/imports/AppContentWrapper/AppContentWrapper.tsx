import svgPaths from "./svg-w7w0o6n3z1";

function TextOverflow() {
  return (
    <div className="content-stretch flex h-[18px] items-start overflow-clip relative shrink-0" data-name="Text overflow">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px] whitespace-nowrap">Models</p>
    </div>
  );
}
...
function TextOverflow1() {
  return (
    <div className="content-stretch flex h-[18px] items-start overflow-clip relative shrink-0" data-name="Text overflow">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px] whitespace-nowrap">Data</p>
    </div>
  );
}
...
function TextOverflow2() {
  return (
    <div className="content-stretch flex h-[18px] items-start overflow-clip relative shrink-0" data-name="Text overflow">
      <p className="font-['IBM_Plex_Sans:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px] whitespace-nowrap">Decision operations</p>
    </div>
  );
}
...
function TextOverflow3() {
  return (
    <div className="content-stretch flex h-[18px] items-start overflow-clip relative shrink-0" data-name="Text overflow">
      <p className="font-['IBM_Plex_Sans:SemiBold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] whitespace-nowrap">Test suite</p>
    </div>
  );
}
...
function Tabs() {
  return (
    <div className="content-stretch flex gap-px items-start overflow-x-auto overflow-y-clip relative shrink-0" data-name="Tabs">
      <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[11px] relative shrink-0" data-name="_Horizontal tabs items">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <div aria-hidden="true" className="absolute border-[#c6c6c6] border-b-2 border-solid inset-0 pointer-events-none" />
        <TextOverflow />
      </div>
      <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[11px] relative shrink-0" data-name="_Horizontal tabs items">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
...
function PageTabs() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Page tabs">
      <div className="content-stretch flex items-start justify-between pl-[16px] relative size-full">
        <div className="content-stretch flex flex-[1_0_0] gap-px items-start min-w-px relative" data-name="Tabs">
          <Tabs />
        </div>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-full z-[2]">
      <PageTabs />
    </div>
  );
}
...
function TextOverflow4() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="Text overflow">
      <p className="font-['IBM_Plex_Sans:SemiBold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#161616] text-[14px] tracking-[0.16px] whitespace-nowrap">Test Cases</p>
    </div>
  );
}
...
function TextOverflow5() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0" data-name="Text overflow">
      <p className="font-['IBM_Plex_Sans:Bold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#525252] text-[14px] tracking-[0.16px] whitespace-nowrap">Test Runs</p>
    </div>
  );
}
...
function Tabs1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px overflow-clip relative" data-name="Tabs">
      <div className="bg-white flex-[1_0_0] min-w-px relative" data-name="_Horizontal tabs items">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col items-start px-[16px] py-[15px] relative size-full">
            <TextIcon />
          </div>
        </div>
        <div aria-hidden="true" className="absolute border-[#0f62fe] border-solid border-t-2 inset-0 pointer-events-none" />
      </div>
      <div className="bg-[#e0e0e0] flex-[1_0_0] min-w-px relative" data-name="_Horizontal tabs items">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col items-start px-[16px] py-[15px] relative size-full">
            <TextIcon1 />
          </div>
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Play">
        ...
        <div className="absolute inset-[12.5%_18.75%_12.5%_12.5%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 12">
            <path d={svgPaths.p2d8fe100} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function PageTabs1() {
  return (
    <div className="content-stretch flex h-[48px] items-start relative shrink-0 w-full" data-name="Page tabs">
      <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Tabs">
        <Tabs1 />
      </div>
      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Menu button">
        <div className="bg-[#393939] content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[128px]" data-name="Button">
          <ButtonContent />
        </div>
      </div>
    </div>
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center pr-[16px] py-[7px] relative size-full">
            <div className="content-stretch flex h-[18px] items-start relative shrink-0" data-name="_Tree view spacer - Leaf node">
              <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
              <div className="h-full shrink-0 w-[40px]" data-name="Spacer" />
            </div>
            <Content />
          </div>
        </div>
          ...
          <div className="content-stretch flex items-center pr-[16px] py-[7px] relative size-full">
            <div className="flex flex-row items-center self-stretch">
              <div className="content-stretch flex h-full items-start relative shrink-0" data-name="_Tree view spacer - Branch node">
                <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
                <div className="h-full shrink-0 w-[16px]" data-name="Spacer" />
              </div>
            </div>
            <Content1 />
          </div>
          ...
          <div className="content-stretch flex items-center pr-[16px] py-[7px] relative size-full">
            <div className="flex flex-row items-center self-stretch">
              <div className="content-stretch flex h-full items-start relative shrink-0" data-name="_Tree view spacer - Leaf node">
                <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
                <div className="h-full shrink-0 w-[88px]" data-name="Spacer" />
              </div>
            </div>
            <Content3 />
          </div>
      ...
      <div className="bg-white relative shrink-0 w-full" data-name="Branch node item">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center pr-[16px] py-[7px] relative size-full">
            <div className="content-stretch flex h-[18px] items-start relative shrink-0" data-name="_Tree view spacer - Leaf node">
              <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
              <div className="h-full shrink-0 w-[64px]" data-name="Spacer" />
            </div>
            <Content13 />
          </div>
        </div>
...
function TextOverflow21() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[18px] items-start min-w-px overflow-clip relative" data-name="Text Overflow">
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] h-[18px] leading-[18px] min-w-px not-italic overflow-hidden relative text-[14px] text-ellipsis text-white tracking-[0.16px] whitespace-nowrap">{`Data & Assertions`}</p>
    </div>
  );
}

function TextOverflow22() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[18px] items-start min-w-px overflow-clip relative" data-name="Text Overflow">
      <p className="flex-[1_0_0] font-['IBM_Plex_Sans:Regular',sans-serif] h-[18px] leading-[18px] min-w-px not-italic overflow-hidden relative text-[#525252] text-[14px] text-ellipsis tracking-[0.16px] whitespace-nowrap">Test Results</p>
    </div>
  );
}
...
function CardSectionHeaderGroup() {
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Card Section Header Group">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-between pl-[16px] pr-[8px] py-[8px] relative size-full">
        ...
        <div className="content-stretch flex items-start relative rounded-[4px] shrink-0 w-[328px]" data-name="Content switcher">
...
function CardSectionHeaderWrapper() {
  return (
    <div className="bg-white content-stretch flex items-start relative shrink-0 w-full z-[1]" data-name="Card Section Header Wrapper">
...
function CardSection() {
  return (
    <div className="content-stretch flex flex-col isolate items-start overflow-clip relative shrink-0 w-full" data-name="Card Section">
...
function ResourceList() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="Resource List">
      <CardSection />
    </div>
  );
}
...
function PanelProviderPage1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-start min-w-px relative" data-name="Panel Provider: Page">
      <PageContentWrapper />
    </div>
  );
}

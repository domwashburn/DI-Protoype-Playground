import svgPaths from "./svg-a8zpv5zjxf";
...
function TagContent() {
  return (
    <div className="content-stretch flex h-[24.001px] items-center py-[3px] relative rounded-[24px] shrink-0" data-name="Tag content">
      <Label />
    </div>
  );
}
...
function PanelHeaderGroup() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-w-px relative" data-name="Panel header group">
      <PanelTitleWrapper />
      <div className="bg-[#e0e0e0] content-stretch flex items-start relative rounded-[12px] shrink-0" data-name="Chat Mode Tag">
        <TagContent />
      </div>
    </div>
  );

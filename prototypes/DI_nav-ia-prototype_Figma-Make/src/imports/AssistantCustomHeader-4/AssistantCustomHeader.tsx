import svgPaths from "./svg-4505u938fq";
...
function PanelTitle() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[177px]" data-name="Panel Title">
      <div className="content-stretch flex gap-[4px] items-center max-w-[312px] min-w-[40px] pr-[28px] relative shrink-0" data-name="Custom chat header">
        <p className="[word-break:break-word] font-['IBM_Plex_Sans:SemiBold',sans-serif] leading-[18px] max-w-[280px] not-italic overflow-hidden relative shrink-0 text-[#161616] text-[14px] text-ellipsis tracking-[0.16px] whitespace-nowrap">Decision Assistant</p>
        <div className="-translate-y-1/2 absolute bg-[#e8e8e8] content-stretch cursor-pointer flex items-center p-[4px] right-0 rounded-[4px] size-[24px] top-1/2" data-name="inline icon button">
...
function Icon3() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 z-[1]" data-name="Icon">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Right-panel--close">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <div className="absolute inset-[12.5%_6.25%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 12">
            <path d={svgPaths.p17c19f80} fill="var(--fill-0, #161616)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function OpenCloseExpandActions() {
  return (
    <div className="content-stretch flex items-center justify-end relative shrink-0" data-name="Open Close Expand Actions">
      <Divider />
      <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[40px]" data-name="Expand panel button">
        <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0)] inset-0 mix-blend-multiply pointer-events-none" />
        <ButtonContent3 />
      </div>

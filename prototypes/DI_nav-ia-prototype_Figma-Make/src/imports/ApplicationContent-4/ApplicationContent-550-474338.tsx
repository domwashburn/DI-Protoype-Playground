import svgPaths from "./svg-0oby3xo0nm";
import { imgChatContentScrollArea, imgGradientWrapper, imgGradientStop1, imgGradientFeather, imgGradientStop2 } from "./svg-r4y0e";

import svgPaths from "./svg-w0f3il7ukh";
...
export default function HelpPanelNestedView() {
  return (
    <div className="bg-[#161616] content-stretch flex flex-col items-start justify-center relative size-full" data-name="Help Panel -> Nested view">
      <Container />
      <Frame />
      <Container2 />
    </div>

import svgPaths from "./svg-f5xsef5ukq";
import { imgChatContentScrollArea, imgGradientWrapper, imgGradientStop1, imgGradientFeather, imgGradientStop2 } from "./svg-inqbp";
...
function AiBackgroundLayerWrapper() {
  return (
    <div className="absolute content-stretch flex flex-col inset-0 items-start pb-[56px]" data-name="AI background layer wrapper">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="[word-break:break-word] content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',sans-serif] gap-[2px] items-start not-italic pb-[48px] pt-[16px] px-[16px] relative size-full">
        <div className="leading-[0] overflow-hidden relative shrink-0 text-[#161616] text-[14px] text-ellipsis tracking-[0.16px] w-full whitespace-pre-wrap">
          <p className="leading-[18px] mb-0">{`Create a new decision `}</p>
          <p className="leading-[18px]">service</p>
        </div>
...
function ChatContent() {
  return (
    <div className="content-stretch flex flex-col items-center pb-[28px] pt-[4px] relative shrink-0 w-full" data-name="Chat content">
      ...
      <div className="absolute bg-[#e0e0e0] content-stretch flex items-start left-[240px] rounded-[9px] top-[340px]" data-name="Tag - Read-only">
        <TagContent />
      </div>
    </div>
  );
...
function ChatContentScrollArea() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[320px_756px] min-h-px relative w-full" style={{ maskImage: `url('${imgChatContentScrollArea}')` }} data-name="Chat content scroll area">
      <ChatContent />
    </div>
  );
}
...
function ChatContentWrapper() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-h-px relative w-full z-[1]" data-name="Chat content wrapper">
      <ChatContentMask />
...
function HeaderBody() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col isolate items-center min-h-px relative w-full" data-name="Header + Body">
      <div className="bg-white content-stretch flex items-start justify-end relative shrink-0 w-full z-[2]" data-name="Assistant Custom Header">
...
function AiBorder() {
  return (
    <div className="absolute content-stretch flex inset-0 items-center justify-end pr-px" data-name="AI border">
      <div className="flex h-full items-center justify-center relative shrink-0 w-0" style={{ containerType: "size", "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-90 w-[100cqh]">
          <div className="h-0 relative w-full" data-name="AI border">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 852 1">
                <line id="AI border" stroke="url(#paint0_linear_517_84037)" x2="852" y1="0.5" y2="0.5" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_517_84037" x1="0" x2="852" y1="1.5" y2="1.5">
                    <stop stopColor="#A6C8FF" stopOpacity="0.64" />
      ...
      <div className="flex-[1_0_0] h-full min-w-px opacity-0 relative" data-name="Spacer" />
    </div>
  );
}

function ChatShellCarbonForAi() {
  return (
    <div className="absolute content-stretch flex flex-col h-[852px] items-center left-[410px] overflow-clip shadow-[0px_23px_40px_-24px_rgba(15,98,254,0.1)] top-[48px] w-[320px]" data-name="Chat shell | Carbon for AI">
...
export default function NewChatChatPanel() {
  return (
    <div className="bg-[#f4f4f4] relative size-full" data-name="New chat: Chat panel 24">
      <div className="absolute bg-[#161616] content-stretch flex h-[48px] items-center left-0 top-0 w-[730px]" data-name="Global header">
        <Frame />

import svgPaths from "./svg-91s94u3bla";
...
function PanelTitle() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Panel Title">
      <div className="content-stretch flex gap-[4px] items-center max-w-[312px] min-w-[40px] pr-[52px] relative shrink-0" data-name="Custom chat header">
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Settings--adjust">
        ...
        <div className="absolute inset-[12.5%_6.25%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 12">
            <g id="Vector">
              <path d={svgPaths.p21417800} fill="#C6C6C6" />
              <path d={svgPaths.p2a3480} fill="#C6C6C6" />
            </g>
          </svg>
        </div>
      </div>
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Document--multiple-02">
        ...
        <div className="absolute inset-[6.25%_12.5%_3.13%_12.5%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 14.5">
            <g id="Vector">
              <path d={svgPaths.p118cc600} fill="var(--fill-0, #C6C6C6)" />
              <path d={svgPaths.p347adc00} fill="var(--fill-0, #C6C6C6)" />
              <path d="M10 7H6V8H10V7Z" fill="var(--fill-0, #C6C6C6)" />
              <path d={svgPaths.p9023a80} fill="var(--fill-0, #C6C6C6)" />
            </g>
          </svg>
        </div>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 z-[1]" data-name="Icon">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Right-panel--close">
        ...
        <div className="absolute inset-[12.5%_6.25%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 12">
            <path d={svgPaths.p17c19f80} fill="var(--fill-0, #C6C6C6)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
      ...
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Close">
        ...
        <div className="absolute inset-1/4" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
            <path d={svgPaths.p314604c0} fill="var(--fill-0, #C6C6C6)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>

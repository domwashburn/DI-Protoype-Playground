          ...
          <Column sm={4} md={8} lg={16}>
            <section className={styles.hubHero} aria-labelledby="hub-title">
              <div className={styles.hubHeroCopy}>
                <div className={styles.docsEyebrow}>Decision Intelligence</div>
                <h1 id="hub-title">Prototype Hub</h1>
                <p>
                  Manage DI prototypes, track design intent, review docs and recordings,
                  and launch working experiments from one place.
                </p>
              </div>
          ...
          <div className={styles.managementPage}>
            ...
            <section className={styles.hubToolbar} aria-label="Registry search">
              ...
              {statusOptions.length > 1 && (
                <div className={styles.hubStatusFilters} role="group" aria-label="Filter registry by status">
            ...
            <section className={styles.hubList} aria-label="Prototype registry index">
              {prototypes.length === 0 ? (
                <Tile className={styles.emptyState}>
                  <h2>No prototypes registered yet.</h2>
                  <p>
                    Add your first prototype to{' '}
                    <code>playground-app/src/data/registry.js</code> and it will
                ...
                <div className={styles.registryBoard}>
                  <div className={styles.registryBoardHeader}>
                    <div>
                      ...
                      <p>
                        Workspace objects with launch readiness, docs, recordings, and context coverage.
                      </p>
                    </div>
                  ...
                  {filteredPrototypes.length === 0 && query && (
                    <Tile className={styles.emptyState}>
